...
/// <summary>
/// UspGetSoccerTournamentOptionsByManager
/// </summary>
public class UspGetSoccerTournamentOptionsByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTournamentOptionsByManager]";
