...
/// <summary>
/// UspGetSoccerTeamPostsBySlug
/// </summary>
public class UspGetSoccerTeamPostsBySlug(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamPostsBySlug]";
