...
/// <summary>
/// UspGetSoccerDataExportByUser
/// </summary>
public class UspGetSoccerDataExportByUser(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerDataExportByUser]";
