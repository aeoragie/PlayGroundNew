...
/// <summary>
/// UspGetSoccerTeamInfoByManager
/// </summary>
public class UspGetSoccerTeamInfoByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamInfoByManager]";
