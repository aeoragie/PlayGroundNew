...
/// <summary>
/// UspGetSoccerApplicationsByGuardian
/// </summary>
public class UspGetSoccerApplicationsByGuardian(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerApplicationsByGuardian]";
