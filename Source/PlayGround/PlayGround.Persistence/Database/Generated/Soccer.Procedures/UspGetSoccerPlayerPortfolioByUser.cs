...
/// <summary>
/// UspGetSoccerPlayerPortfolioByUser
/// </summary>
public class UspGetSoccerPlayerPortfolioByUser(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerPlayerPortfolioByUser]";
