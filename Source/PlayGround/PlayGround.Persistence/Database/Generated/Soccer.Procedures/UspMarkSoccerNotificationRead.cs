...
/// <summary>
/// UspMarkSoccerNotificationRead
/// </summary>
public class UspMarkSoccerNotificationRead(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspMarkSoccerNotificationRead]";
