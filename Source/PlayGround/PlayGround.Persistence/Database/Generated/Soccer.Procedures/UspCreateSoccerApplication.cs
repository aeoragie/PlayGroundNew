...
/// <summary>
/// UspCreateSoccerApplication
/// </summary>
public class UspCreateSoccerApplication(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCreateSoccerApplication]";
    ...
    public override DynamicParameters BuildParameters()
    {
		...
		Parameters.Add("@DesiredPosition", DesiredPosition);
