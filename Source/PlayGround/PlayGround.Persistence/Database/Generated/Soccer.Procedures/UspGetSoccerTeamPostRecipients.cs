...
/// <summary>
/// UspGetSoccerTeamPostRecipients
/// </summary>
public class UspGetSoccerTeamPostRecipients(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamPostRecipients]";
