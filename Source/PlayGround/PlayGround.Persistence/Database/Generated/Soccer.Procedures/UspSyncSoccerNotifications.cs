...
/// <summary>
/// UspSyncSoccerNotifications
/// </summary>
public class UspSyncSoccerNotifications(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspSyncSoccerNotifications]";
