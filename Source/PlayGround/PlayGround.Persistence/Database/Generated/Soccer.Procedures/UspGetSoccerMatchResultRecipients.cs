...
/// <summary>
/// UspGetSoccerMatchResultRecipients
/// </summary>
public class UspGetSoccerMatchResultRecipients(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerMatchResultRecipients]";
