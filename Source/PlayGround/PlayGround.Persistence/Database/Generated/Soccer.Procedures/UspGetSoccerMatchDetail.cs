...
/// <summary>
/// UspGetSoccerMatchDetail
/// </summary>
public class UspGetSoccerMatchDetail(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerMatchDetail]";
