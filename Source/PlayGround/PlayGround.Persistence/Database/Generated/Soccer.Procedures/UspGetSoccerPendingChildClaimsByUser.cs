...
/// <summary>
/// UspGetSoccerPendingChildClaimsByUser
/// </summary>
public class UspGetSoccerPendingChildClaimsByUser(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerPendingChildClaimsByUser]";
