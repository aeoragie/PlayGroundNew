...
/// UspApprovePayment
/// </summary>
public class UspApprovePayment(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspApprovePayment]";

	public Guid UserId { get; set; } = Guid.Empty;
	public string OrderId { get; set; } = String.Empty;
	public string PaymentKey { get; set; } = String.Empty;
	public string Method { get; set; } = String.Empty;
	public SystemTime ApprovedAt { get; set; } = SystemTime.MinValue;
    public override DynamicParameters BuildParameters()
    {
		Parameters.Add("@UserId", UserId);
		Parameters.Add("@OrderId", OrderId);
		Parameters.Add("@PaymentKey", PaymentKey);
