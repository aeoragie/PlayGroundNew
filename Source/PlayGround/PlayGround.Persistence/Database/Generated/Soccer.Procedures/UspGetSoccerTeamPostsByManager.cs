...
/// <summary>
/// UspGetSoccerTeamPostsByManager
/// </summary>
public class UspGetSoccerTeamPostsByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamPostsByManager]";
