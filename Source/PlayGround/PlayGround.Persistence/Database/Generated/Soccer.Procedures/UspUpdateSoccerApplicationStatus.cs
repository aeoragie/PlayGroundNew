...
/// <summary>
/// UspUpdateSoccerApplicationStatus
/// </summary>
public class UspUpdateSoccerApplicationStatus(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspUpdateSoccerApplicationStatus]";
