...
/// <summary>
/// UspCreateSoccerPlayerClaimRequest
/// </summary>
public class UspCreateSoccerPlayerClaimRequest(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCreateSoccerPlayerClaimRequest]";
