...
/// <summary>
/// UspGetPaymentByOrder
/// </summary>
public class UspGetPaymentByOrder(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetPaymentByOrder]";
