...
/// <summary>
/// UspCreateSoccerRecordCorrectionByGuardian
/// </summary>
public class UspCreateSoccerRecordCorrectionByGuardian(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCreateSoccerRecordCorrectionByGuardian]";
