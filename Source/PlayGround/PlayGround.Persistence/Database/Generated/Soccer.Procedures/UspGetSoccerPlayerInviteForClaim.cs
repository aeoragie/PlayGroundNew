...
/// <summary>
/// UspGetSoccerPlayerInviteForClaim
/// </summary>
public class UspGetSoccerPlayerInviteForClaim(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerPlayerInviteForClaim]";
