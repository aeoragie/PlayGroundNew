...
/// <summary>
/// UspGetPendingSoccerDataExports
/// </summary>
public class UspGetPendingSoccerDataExports(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetPendingSoccerDataExports]";
