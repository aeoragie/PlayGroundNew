...
/// <summary>
/// UspGetSoccerTeamSeasonRecordBySlug
/// </summary>
public class UspGetSoccerTeamSeasonRecordBySlug(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamSeasonRecordBySlug]";
