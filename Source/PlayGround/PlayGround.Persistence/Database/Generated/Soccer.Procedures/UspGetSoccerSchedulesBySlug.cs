...
/// <summary>
/// UspGetSoccerSchedulesBySlug
/// </summary>
public class UspGetSoccerSchedulesBySlug(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerSchedulesBySlug]";
