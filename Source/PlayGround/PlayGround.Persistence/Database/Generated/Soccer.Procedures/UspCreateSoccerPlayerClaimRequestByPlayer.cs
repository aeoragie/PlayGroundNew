...
/// <summary>
/// UspCreateSoccerPlayerClaimRequestByPlayer
/// </summary>
public class UspCreateSoccerPlayerClaimRequestByPlayer(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCreateSoccerPlayerClaimRequestByPlayer]";
    ...
    public override DynamicParameters BuildParameters()
    {
		...
		Parameters.Add("@RequesterName", RequesterName);
