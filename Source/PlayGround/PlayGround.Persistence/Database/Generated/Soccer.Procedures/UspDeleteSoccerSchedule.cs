...
/// <summary>
/// UspDeleteSoccerSchedule
/// </summary>
public class UspDeleteSoccerSchedule(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspDeleteSoccerSchedule]";
