...
/// <summary>
/// UspGetSoccerClaimCardBySlug
/// </summary>
public class UspGetSoccerClaimCardBySlug(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerClaimCardBySlug]";
