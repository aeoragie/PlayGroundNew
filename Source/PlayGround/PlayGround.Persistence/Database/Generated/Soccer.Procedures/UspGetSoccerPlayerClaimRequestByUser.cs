...
/// <summary>
/// UspGetSoccerPlayerClaimRequestByUser
/// </summary>
public class UspGetSoccerPlayerClaimRequestByUser(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerPlayerClaimRequestByUser]";
