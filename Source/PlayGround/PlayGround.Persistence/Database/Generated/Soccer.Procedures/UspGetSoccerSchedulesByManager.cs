...
/// <summary>
/// UspGetSoccerSchedulesByManager
/// </summary>
public class UspGetSoccerSchedulesByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerSchedulesByManager]";
