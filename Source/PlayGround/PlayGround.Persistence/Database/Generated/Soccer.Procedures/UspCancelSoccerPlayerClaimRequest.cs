...
/// <summary>
/// UspCancelSoccerPlayerClaimRequest
/// </summary>
public class UspCancelSoccerPlayerClaimRequest(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCancelSoccerPlayerClaimRequest]";
