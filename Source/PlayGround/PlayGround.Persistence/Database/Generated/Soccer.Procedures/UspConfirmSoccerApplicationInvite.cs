...
/// <summary>
/// UspConfirmSoccerApplicationInvite
/// </summary>
public class UspConfirmSoccerApplicationInvite(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspConfirmSoccerApplicationInvite]";
