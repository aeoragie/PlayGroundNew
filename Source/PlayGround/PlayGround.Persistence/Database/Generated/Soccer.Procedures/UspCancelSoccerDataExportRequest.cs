...
/// <summary>
/// UspCancelSoccerDataExportRequest
/// </summary>
public class UspCancelSoccerDataExportRequest(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCancelSoccerDataExportRequest]";
