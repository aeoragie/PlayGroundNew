...
/// <summary>
/// UspGetSoccerTournamentDetail
/// </summary>
public class UspGetSoccerTournamentDetail(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTournamentDetail]";
