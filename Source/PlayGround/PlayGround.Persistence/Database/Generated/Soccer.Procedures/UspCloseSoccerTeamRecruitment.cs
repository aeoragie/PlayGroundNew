...
/// <summary>
/// UspCloseSoccerTeamRecruitment
/// </summary>
public class UspCloseSoccerTeamRecruitment(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCloseSoccerTeamRecruitment]";
