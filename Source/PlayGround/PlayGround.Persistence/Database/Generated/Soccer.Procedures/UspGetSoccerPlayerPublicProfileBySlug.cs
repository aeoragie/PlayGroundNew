...
/// <summary>
/// UspGetSoccerPlayerPublicProfileBySlug
/// </summary>
public class UspGetSoccerPlayerPublicProfileBySlug(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerPlayerPublicProfileBySlug]";
