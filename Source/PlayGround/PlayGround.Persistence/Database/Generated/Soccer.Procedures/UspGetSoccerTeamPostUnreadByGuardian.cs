...
/// <summary>
/// UspGetSoccerTeamPostUnreadByGuardian
/// </summary>
public class UspGetSoccerTeamPostUnreadByGuardian(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamPostUnreadByGuardian]";
