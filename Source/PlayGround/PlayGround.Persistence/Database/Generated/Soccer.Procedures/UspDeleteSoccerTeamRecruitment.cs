...
/// <summary>
/// UspDeleteSoccerTeamRecruitment
/// </summary>
public class UspDeleteSoccerTeamRecruitment(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspDeleteSoccerTeamRecruitment]";
