...
/// <summary>
/// UspGetSoccerTournamentOgById
/// </summary>
public class UspGetSoccerTournamentOgById(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTournamentOgById]";
