...
/// <summary>
/// UspMarkSoccerNotificationsRead
/// </summary>
public class UspMarkSoccerNotificationsRead(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspMarkSoccerNotificationsRead]";
    ...
    public override DynamicParameters BuildParameters()
    {
		...
		Parameters.Add("@IdsJson", IdsJson);
