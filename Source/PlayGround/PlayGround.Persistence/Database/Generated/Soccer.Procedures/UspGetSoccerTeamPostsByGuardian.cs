...
/// <summary>
/// UspGetSoccerTeamPostsByGuardian
/// </summary>
public class UspGetSoccerTeamPostsByGuardian(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamPostsByGuardian]";
