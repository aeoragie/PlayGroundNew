...
/// <summary>
/// UspCreateSoccerTeamWithRoster
/// </summary>
public class UspCreateSoccerTeamWithRoster(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCreateSoccerTeamWithRoster]";
