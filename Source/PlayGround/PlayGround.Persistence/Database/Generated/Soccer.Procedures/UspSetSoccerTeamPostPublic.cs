...
/// <summary>
/// UspSetSoccerTeamPostPublic
/// </summary>
public class UspSetSoccerTeamPostPublic(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspSetSoccerTeamPostPublic]";
