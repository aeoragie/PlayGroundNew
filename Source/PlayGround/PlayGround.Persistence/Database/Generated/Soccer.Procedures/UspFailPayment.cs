...
/// UspFailPayment
/// </summary>
public class UspFailPayment(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspFailPayment]";
    ...
    public override DynamicParameters BuildParameters()
    {
		...
		Parameters.Add("@FailReason", FailReason);
