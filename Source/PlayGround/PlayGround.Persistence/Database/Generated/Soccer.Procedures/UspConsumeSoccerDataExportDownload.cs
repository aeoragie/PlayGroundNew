...
/// <summary>
/// UspConsumeSoccerDataExportDownload
/// </summary>
public class UspConsumeSoccerDataExportDownload(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspConsumeSoccerDataExportDownload]";
