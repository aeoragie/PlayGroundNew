...
/// <summary>
/// UspMarkSoccerTeamPostRead
/// </summary>
public class UspMarkSoccerTeamPostRead(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspMarkSoccerTeamPostRead]";
