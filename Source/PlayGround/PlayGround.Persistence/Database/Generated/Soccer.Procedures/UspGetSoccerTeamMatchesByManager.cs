...
/// <summary>
/// UspGetSoccerTeamMatchesByManager
/// </summary>
public class UspGetSoccerTeamMatchesByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamMatchesByManager]";
