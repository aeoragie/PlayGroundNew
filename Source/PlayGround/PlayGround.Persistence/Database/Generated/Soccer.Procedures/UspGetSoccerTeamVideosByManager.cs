...
/// <summary>
/// UspGetSoccerTeamVideosByManager
/// </summary>
public class UspGetSoccerTeamVideosByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamVideosByManager]";
