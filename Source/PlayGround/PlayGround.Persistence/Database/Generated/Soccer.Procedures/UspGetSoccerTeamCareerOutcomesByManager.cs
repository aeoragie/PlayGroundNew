...
/// <summary>
/// UspGetSoccerTeamCareerOutcomesByManager
/// </summary>
public class UspGetSoccerTeamCareerOutcomesByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamCareerOutcomesByManager]";
