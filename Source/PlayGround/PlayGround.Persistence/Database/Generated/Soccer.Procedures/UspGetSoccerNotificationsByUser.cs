...
/// <summary>
/// UspGetSoccerNotificationsByUser
/// </summary>
public class UspGetSoccerNotificationsByUser(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerNotificationsByUser]";
