...
/// <summary>
/// UspGetLandingContents
/// </summary>
public class UspGetLandingContents(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetLandingContents]";
