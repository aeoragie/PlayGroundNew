...
/// <summary>
/// UspGetSoccerTournamentsBySeason
/// </summary>
public class UspGetSoccerTournamentsBySeason(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTournamentsBySeason]";
