...
/// <summary>
/// UspGetSoccerRecordCorrectionsByManager
/// </summary>
public class UspGetSoccerRecordCorrectionsByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerRecordCorrectionsByManager]";
