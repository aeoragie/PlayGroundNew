...
/// <summary>
/// UspGetSoccerPendingInvitesByManager
/// </summary>
public class UspGetSoccerPendingInvitesByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerPendingInvitesByManager]";
