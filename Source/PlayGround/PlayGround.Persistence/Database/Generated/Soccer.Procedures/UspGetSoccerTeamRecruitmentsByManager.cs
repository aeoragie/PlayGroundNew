...
/// <summary>
/// UspGetSoccerTeamRecruitmentsByManager
/// </summary>
public class UspGetSoccerTeamRecruitmentsByManager(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamRecruitmentsByManager]";
