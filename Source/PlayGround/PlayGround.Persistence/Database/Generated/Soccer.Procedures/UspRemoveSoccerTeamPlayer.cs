...
/// <summary>
/// UspRemoveSoccerTeamPlayer
/// </summary>
public class UspRemoveSoccerTeamPlayer(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspRemoveSoccerTeamPlayer]";
    ...
    public override DynamicParameters BuildParameters()
    {
		...
		Parameters.Add("@TeamPlayerId", TeamPlayerId);
