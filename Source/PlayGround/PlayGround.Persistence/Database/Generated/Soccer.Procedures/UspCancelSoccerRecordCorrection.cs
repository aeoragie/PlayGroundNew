...
/// <summary>
/// UspCancelSoccerRecordCorrection
/// </summary>
public class UspCancelSoccerRecordCorrection(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspCancelSoccerRecordCorrection]";
    ...
    public override DynamicParameters BuildParameters()
    {
		...
		Parameters.Add("@CorrectionId", CorrectionId);
