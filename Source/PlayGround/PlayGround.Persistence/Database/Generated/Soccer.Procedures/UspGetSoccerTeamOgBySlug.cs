...
/// <summary>
/// UspGetSoccerTeamOgBySlug
/// </summary>
public class UspGetSoccerTeamOgBySlug(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamOgBySlug]";
