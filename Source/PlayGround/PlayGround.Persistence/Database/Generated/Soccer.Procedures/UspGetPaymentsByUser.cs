...
/// <summary>
/// UspGetPaymentsByUser
/// </summary>
public class UspGetPaymentsByUser(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetPaymentsByUser]";
