...
/// <summary>
/// UspSaveSoccerPlayerStrengthTags
/// </summary>
public class UspSaveSoccerPlayerStrengthTags(RepositoryBase repository) : ProcedureBase(repository)
{
    ...
    public override DynamicParameters BuildParameters()
    {
		...
		Parameters.Add("@TagsJson", TagsJson);
