...
/// <summary>
/// UspGetSoccerTeamCareerOutcomesBySlug
/// </summary>
public class UspGetSoccerTeamCareerOutcomesBySlug(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspGetSoccerTeamCareerOutcomesBySlug]";
