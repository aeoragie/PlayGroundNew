...
/// <summary>
/// UspSetNotificationPreference
/// </summary>
public class UspSetNotificationPreference(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspSetNotificationPreference]";
