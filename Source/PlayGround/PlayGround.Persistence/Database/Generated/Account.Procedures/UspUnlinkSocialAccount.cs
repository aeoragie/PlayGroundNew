...
/// <summary>
/// UspUnlinkSocialAccount
/// </summary>
public class UspUnlinkSocialAccount(RepositoryBase repository) : ProcedureBase(repository)
{
    public override string Procedure => "[dbo].[UspUnlinkSocialAccount]";
