...
SELECT UPPER(LEFT(REPLACE(CONVERT(VARCHAR(36), NEWID()), '-', ''), 6)), [PlayerId], 'B0000000-0000-0000-0000-000000000001'
FROM @roster
WHERE [IsClaimed] = 0;
GO
...
INSERT INTO [dbo].[SoccerPlayerInvites] ([Code], [PlayerId], [TeamId])
SELECT UPPER(LEFT(REPLACE(CONVERT(VARCHAR(36), NEWID()), '-', ''), 6)), [PlayerId], 'B0000000-0000-0000-0000-000000000002'
FROM @roster
WHERE [IsClaimed] = 0;
GO
...
INSERT INTO [dbo].[SoccerPlayerInvites] ([Code], [PlayerId], [TeamId])
SELECT UPPER(LEFT(REPLACE(CONVERT(VARCHAR(36), NEWID()), '-', ''), 6)), [PlayerId], 'B0000000-0000-0000-0000-000000000003'
FROM @roster
WHERE [IsClaimed] = 0;
GO
...
INSERT INTO [dbo].[SoccerPlayerInvites] ([Code], [PlayerId], [TeamId])
SELECT UPPER(LEFT(REPLACE(CONVERT(VARCHAR(36), NEWID()), '-', ''), 6)), [PlayerId], 'B0000000-0000-0000-0000-000000000004'
FROM @roster
WHERE [IsClaimed] = 0;
GO
...
INSERT INTO [dbo].[SoccerPlayerInvites] ([Code], [PlayerId], [TeamId])
SELECT UPPER(LEFT(REPLACE(CONVERT(VARCHAR(36), NEWID()), '-', ''), 6)), [PlayerId], 'B0000000-0000-0000-0000-000000000005'
FROM @roster
WHERE [IsClaimed] = 0;
GO
...
INSERT INTO [dbo].[SoccerPlayerInvites] ([Code], [PlayerId], [TeamId])
SELECT UPPER(LEFT(REPLACE(CONVERT(VARCHAR(36), NEWID()), '-', ''), 6)), [PlayerId], 'B0000000-0000-0000-0000-000000000006'
FROM @roster
WHERE [IsClaimed] = 0;
GO
