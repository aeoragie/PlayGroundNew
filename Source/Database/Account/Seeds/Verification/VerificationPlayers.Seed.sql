...
-- PasswordHash는 검증 계정 공통 값 재사용 (ASP.NET Identity 해시 — salt 내장이라 복제 가능).
-- UserId는 Soccer 시드(Verification/VerificationPlayerLinks.Seed.sql)가 검증fc 로스터와 연결하는 고정 GUID.
--   D01 = 검증fc #7 신준우(U12), D11 = 검증fc #1 김정현(U15).
